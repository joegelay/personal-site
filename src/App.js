  ...
  return (
    <div className="App">
      ...
      <nav class="main-nav">
        ...
        <a class="main-nav-link" href="" href="">Projects</a>
        <a class="main-nav-link" href="" href="">Resume</a>
        <a class="main-nav-link" href="" href="">Writing</a>
        <a class="main-nav-link" href="" href="">Reading</a>
      </nav>
