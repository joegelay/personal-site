  ...
  render() {
    return (
        <div className="content">
            ...
            <p id="blurb">I'm a full stack developer with a deep love for learning, solving problems, and connecting people.
            <br></br> 
            <br></br> 
            ...
            <a className="contact-icon-a" href="https://www.linkedin.com/in/joegelay/" rel="noopener noreferrer" target="_blank">
